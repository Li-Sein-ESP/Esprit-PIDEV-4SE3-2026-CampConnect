...
class DeliveryServiceTest {
    ...
    void updateStatus_ShouldUpdate_WhenTransitionIsValid() {
        ...
        DeliveryResponse response = deliveryService.updateStatus("delivery-1", DeliveryStatus.PENDING, null);
    ...
    void updateStatus_ShouldThrowConflict_WhenTransitionIsInvalid() {
        ...
        assertThrows(ConflictException.class,
                () -> deliveryService.updateStatus("delivery-1", DeliveryStatus.DELIVERED, null));
    }
    ...
    void updateStatus_ShouldCompleteRental_WhenMarkedDelivered() {
        ...
        DeliveryResponse response = deliveryService.updateStatus("delivery-1", DeliveryStatus.DELIVERED, null);
