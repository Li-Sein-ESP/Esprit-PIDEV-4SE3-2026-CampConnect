...
public class GroupController {
    ...
    private final com.campconnect.repository.GroupMessageRepository groupMessageRepository;

    @GetMapping("/{id}/messages")
    public ResponseEntity<List<com.campconnect.model.GroupMessage>> getGroupMessages(@PathVariable("id") String id) {
        return ResponseEntity.ok(groupMessageRepository.findByGroupIdOrderByCreatedAtAsc(id));
    }
