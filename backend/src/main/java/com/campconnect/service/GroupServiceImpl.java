...
public class GroupServiceImpl implements IGroupService {
    ...
    private final com.campconnect.repository.TripIntentRepository tripIntentRepository;
    ...
    private void populateTripDates(Group group) {
        if (group.getTripId() != null) {
            tripIntentRepository.findById(group.getTripId()).ifPresent(trip -> {
                group.setStartDate(trip.getDateFrom());
                group.setEndDate(trip.getDateTo());
            });
        }
    }
