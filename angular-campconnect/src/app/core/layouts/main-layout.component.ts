...
import { GearRecommendationTriggerComponent } from '../../features/recommendations/gear-recommendation-trigger/gear-recommendation-trigger.component';
import { filter } from 'rxjs/operators';

@Component({
  selector: 'app-main-layout',
  standalone: true,
  imports: [CommonModule, RouterModule, NavigationComponent, GearRecommendationTriggerComponent],
  template: `
    <div class="min-h-screen flex flex-col">
      ...
      <!-- Gear Recommendation Floating Trigger -->
      <app-gear-recommendation-trigger></app-gear-recommendation-trigger>
    </div>
  `,
  styles: []
})
