...
export class GearApiService {
    ...
    /**
     * GET /api/gear/{gearId}/booked-dates
     * Returns all non-cancelled rental date ranges for a gear item.
     */
    getBookedDates(gearId: string): Observable<BookedDateRange[]> {
        return this.http.get<BookedDateRange[]>(`${this.base}/${gearId}/booked-dates`);
    }
}
