      ...
      <div class="flex-1 flex items-center justify-center p-6 lg:p-12 bg-[var(--color-background)]">
        <div class="w-full max-w-md">
          ...
          >
            ...
            <!-- Error Message -->
            <div *ngIf="errorMessage" class="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg text-sm">
                {{ errorMessage }}
            </div>
            ...
            <form (ngSubmit)="handleSubmit()" class="space-y-5">
              ...
              <div>
                <label for="role" class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
                ...
                <div class="relative">
                  <select
                    ...
                    required
                  >
                    <option value="camper">I want to go camping (Camper)</option>
                    <option value="equipment_provider">I want to rent out gear (Equipment Provider)</option>
                    <option value="site_owner">I have a campsite (Site Owner)</option>
                    <option value="delivery_provider">I want to deliver gear (Delivery Driver)</option>
                    <option value="organizer">I organize trips (Trip Organizer)</option>
                  </select>
                </div>
              </div>
