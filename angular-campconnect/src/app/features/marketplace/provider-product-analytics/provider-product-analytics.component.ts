...
export class ProviderProductAnalyticsComponent implements OnInit {
    productId: string = '';
    ...
    analytics = {
        ...
        revenueTrend: [
            820, 940, 780, 1100, 1350, 1280, 950, 870, 1020, 1180, 1400, 1550, 1320, 1100, 980, 1060, 1240, 1380, 1500, 1420, 1180, 1050, 1160, 1340, 1520, 1680, 1450, 1300, 1420, 1560
        ],
        rentalsTrend: [
            { label: 'W1', value: 142 },
            { label: 'W2', value: 168 },
    ...
    generateRevenuePolygon(): string {
        ...
        const data = this.analytics.revenueTrend;
