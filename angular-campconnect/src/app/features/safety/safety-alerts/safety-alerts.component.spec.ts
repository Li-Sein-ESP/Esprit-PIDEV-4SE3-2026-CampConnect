...
describe("SafetyAlertsComponent", () => {
  ...
  beforeEach(async () => {
    mockSafetyService = {
      ...
      getIncidents: jasmine.createSpy("getIncidents").and.returnValue(
        of([
          {
            id: "1",
            title: "Forest Fire",
      ...
      updateAlert: jasmine
        .createSpy("updateAlert")
        .and.returnValue(of({ id: "1", title: "Updated Fire" })),
    };
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: Router, useValue: mockRouter },
        {
          ...
          useValue: { params: of({}), snapshot: { params: {}, data: {} } },
        },
      ],
    }).compileComponents();
