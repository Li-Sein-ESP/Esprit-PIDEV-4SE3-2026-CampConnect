...
export class GroupService {
  ...
  getMyInvitations(userId: string): Observable<any[]> {
    return this.http.get<any[]>(`${environment.apiUrl}/group-invites/user/${userId}`);
  }

  acceptInvitation(id: string): Observable<any> {
    return this.http.patch<any>(`${environment.apiUrl}/group-invites/${id}/accept`, {});
  }

  declineInvitation(id: string): Observable<any> {
    return this.http.patch<any>(`${environment.apiUrl}/group-invites/${id}/decline`, {});
  }
}
