...
export const routes: Routes = [
    ...
    // Admin Portal
    {
        ...
        children: [
            ...
            {
                path: 'sites/new',
                loadComponent: () => import('./features/campsites/campsite-form/campsite-form.component').then(m => m.CampsiteFormComponent)
            },
            {
                path: 'sites/edit/:id',
                loadComponent: () => import('./features/campsites/campsite-form/campsite-form.component').then(m => m.CampsiteFormComponent)
            },
            {
                ...
                loadComponent: () => import('./features/admin/admin-environmental-rules/admin-environmental-rules.component').then(m => m.AdminEnvironmentalRulesComponent)
            },
            {
                path: 'marketplace',
    ...
    // Main Layout Routes
    {
        ...
        children: [
            ...
            // Profile
            {
                ...
                canActivate: [authGuard],
                data: { roles: ['ROLE_USER', 'ROLE_CAMPER', 'ROLE_SITE_OWNER', 'ROLE_EQUIPMENT_PROVIDER', 'ROLE_ORGANIZER', 'ROLE_DELIVERY_PROVIDER', 'ROLE_ADMIN'] }
            },
            {
                path: 'profile',
            ...
            },
            {
                ...
                loadComponent: () => import('./features/campsites/campsite-create/campsite-create.component').then(m => m.CampsiteCreateComponent),
                canActivate: [authGuard],
