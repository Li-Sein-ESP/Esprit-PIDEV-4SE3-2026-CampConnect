  ...
  // Equipment Provider Portal
  {
    ...
    children: [
      ...
      },
      {
        path: "warehouses",
        loadComponent: () =>
          import("./features/marketplace/provider-warehouses/provider-warehouses.component").then(
            (m) => m.ProviderWarehousesComponent,
          ),
      },
      {
        path: "products/new",
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/marketplace/provider-demand-prediction/provider-demand-prediction.component").then(
            (m) => m.ProviderDemandPredictionComponent,
          ),
      },
      {
        path: "",
  ...
  // Delivery Provider Portal
  {
    ...
    children: [
      ...
      },
      {
        path: "fleet",
        loadComponent: () =>
          import("./features/delivery/provider-fleet-dashboard/provider-fleet-dashboard.component").then(
            (m) => m.ProviderFleetDashboardComponent,
          ),
      },
      {
        path: ":deliveryId",
  ...
  // Main Layout Routes
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/payments/payment-receipt/payment-receipt.component").then(
